...
namespace cmpl
{
	...
	const char *commandNames[][30] = {
		...
		{ "FETCH_SPECIAL",		"ARG", "THIS", "CURTUPEL", "CURDESTNAME", "CURDESTTUPEL", "VARBYNAME", "VARBYNO", "CONBYNAME", "CONBYNO", "OBJECTTYPE", "DATATYPE", "TYPEBASE", "TYPEPAR", "ISREADONLY", "DESTNAME", "DESTTUPEL", "DESTFULLNAME", "FULLFORMULA", "FORMULAARRAY" },
		{ "ASSIGN",				"NORMAL", "REF", "ADD", "SUB", "MUL", "DIV", "LHSONLY", "RHSONLY", "EXTERN", "ASSERT" },
		{ "OPERATION",			"ADD", "SUB", "MUL", "DIV", "EXP", "AND", "OR", "NOT", "EQ", "EQ2", "NE", "NE2", "LT", "GT", "LE", "GE", "IN", "OF", "IRR", "TRP", "OBJTO", "INDEX", "FUNC" },
		{ "CONSTRUCT",			"ARRAY", "TUPEL", "IV_WOLB", "IV_LB", "SET" },
