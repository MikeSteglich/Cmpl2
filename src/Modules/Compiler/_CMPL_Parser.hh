...
namespace cmpl {
#line 114 "_CMPL_Parser.hh" // lalr1.cc:377
  ...
  public:
    ...
    union semantic_type
    {
    #line 65 "CMPL_Parser.yy" // lalr1.cc:377
...
#line 172 "_CMPL_Parser.hh" // lalr1.cc:377
    };
#else
  ...
  private:
    ...
    CMPL_Parser (const CMPL_Parser&);
    CMPL_Parser& operator= (const CMPL_Parser&);
