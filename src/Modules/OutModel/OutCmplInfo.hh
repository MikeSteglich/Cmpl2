...
#ifndef OUTCMPLINFO_HH
#define OUTCMPLINFO_HH
...
namespace cmpl
{
	 ...
	 */
    class OutCmplInfo : public ModuleBase
	{

		/************** command line options **********/

	private:
        FileOutput *_outCmplInfo;				///< write model as standard MPS to this file / NULL: no standard MPS output
        bool _matrixOut;
        bool _statOut;
        bool _varProdStatOut;

        string _matrixFileName;
        string _statFileName;
        string _varProdFileName;
	...
	private:
         ...
         */
        void writeCmplInfo(OptModel *om, FileOutput *file);
         ...
         */
        void writeCmplInfo(OptModel *om, ostream& ostr);
